...
<div class="media-header carousel">
	<div class="carousel-inner">
		...
		<img src="<?php echo $this->Html->url('/home/plex_proxy/art/'.$media->getRatingKey()); ?>" alt="" class="img-responsive">
			<div class="carousel-caption">
				<div class="row">
					<div class="col-md-3">
						<img src="<?php echo $this->Html->url('/home/plex_proxy/thumb/'.$media->getRatingKey()); ?>" />
					</div>
					<div class="col-md-9">
